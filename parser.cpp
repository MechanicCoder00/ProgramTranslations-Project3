...
node* assign(ifstream& input)       //Assign function
{
    ...
    if(t.tokenId == IDENT_tk)
    {
        ...
        {
            currentNode->child2 = newNode("Relational");
            currentNode->child2->node_tk = t;
            t = scanner(input,t.lineNum);
            if(t.tokenId == RELAT_tk && t.tokenInstance == "<")
            {
                currentNode->child3 = newNode("Relational");
                currentNode->child3->node_tk = t;
                t = scanner(input,t.lineNum);
                currentNode->child4 = expr(input);
                return currentNode;
            } else {
                error("RELAT_tk","<");
            }
...
node* RO(ifstream& input)       //RO function
{
    ...
    if(t.tokenId == RELAT_tk && t.tokenInstance == "<")
    {
        currentNode->child1 = newNode("Relational");
        currentNode->child1->node_tk = t;
        t = scanner(input,t.lineNum);
        if(t.tokenId == RELAT_tk && t.tokenInstance == "<")
        {
    ...
    {
        currentNode->child1 = newNode("Assignment");
        currentNode->child1->node_tk = t;
        t = scanner(input,t.lineNum);
    } else {
